...
import Kingfisher
import SnapKit
@objc (WLFocusList1TableViewCell)
public final class WLFocusList1TableViewCell: WLFocusListBaseTableViewCell {
    ...
    override public var type: (WLFocusBean ,WLFocusListConfig)! {
...
extension WLFocusList1TableViewCell {
