...
class WLProjectListEmpty: WLTableViewEmptyViewSource {
    var emptyAText: NSAttributedString {
        ...
        return NSAttributedString(string: "暂无黑名单", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15),NSAttributedString.Key.foregroundColor: WLHEXCOLOR(hexColor: WLGlobalManager.default.styleConfig.globalColor) ,NSAttributedString.Key.paragraphStyle: blackListStyle])
...
@objc public class WLProjectListViewController: WLLoadingDisposeF1ViewController {
    ...
    final lazy var soManager: WLSOManager = WLSOManager()
...
extension WLProjectListViewController: WLProjectTableViewCellDelegate {
    ...
    func onFunItemClick(_ pro: WLProjectBean, for indexPath: IndexPath) {
        ...
        let isLogin = checkLoginAndIsGoLogin()
