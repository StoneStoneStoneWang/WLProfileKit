...
Pod::Spec.new do |spec|
  ...
  #    so.source_files = "Code/SO/*.{swift}"
  #    so.dependency 'WLProfileKit/WLProfile/WLProfileVC'
  #    so.dependency 'WLProfileKit/WLWelcome'
  #    so.dependency 'WLProfileKit/Prepare/Req'
  #    so.dependency 'WLBaseViewController'
  #    so.dependency 'WLThirdUtil/Hud'
